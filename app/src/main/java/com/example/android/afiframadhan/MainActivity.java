...
public class MainActivity extends AppCompatActivity {
    ...
    private DatabaseSQL databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHandler = new DatabaseSQL(this);        // Membuat Object DatabaseSQL

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);     // Inisiasi dan asign Toolbar
        setSupportActionBar(toolbar);           // Toolbar as ActionBar
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main, menu);      // Inflate the menu, untuk menambahkan item ke Action Bar
        return true;
    }
...
//        startActivity(intent);
    ...
    public void setRecyclerView(){
        ...
        ItemTouchHelper.Callback callback = new SwipeFunction(mAdapter);
